...
import com.softcross.smartband.domain.bluetooth.BluetoothController
            ...
            currentClientSocket?.let { socket ->
                try {
                    ...
                    BluetoothDataTransferService(socket).also { service ->
                        dataTransferService = service
                        emitAll(
                            service.listenForIncomingDistance()
                                .map { it }
                        )
                    }
                } catch (e: IOException) {
